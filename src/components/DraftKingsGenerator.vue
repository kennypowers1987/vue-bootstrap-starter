        ...
        <b-tabs v-if="playersList">
            ...
            <b-tab title="Lineups">
                ...
                <div class="row col-xs-12 alert alert-info" style="margin:5px" v-if="showSpinner">
                    ...
                    <div class="col-xs-12"> Currently working on {{generateCount - lineups.length}} lineups. Keep clicking "Generate" to generate
                        more. Modify your player exposures to speed things up.</div>
