<template>
    <div class="parse">
        ...
        <div class="alert alert-danger">
            When you download your lineups, in the downloaded .csv, change the headers to 'QB, RB, RB, WR, WR, WR, TE, FLEX, DST' or you won't be able to upload it to DK.
        </div>
                ...
                function validateLineup() {
                    ...
                    if (checkDupes.length < 9) {
                        ...
                        lineup = {
                            ...
                            'RB': that.lineup.RB1.ID,
                            'RB': that.lineup.RB2.ID,
                            'WR': that.lineup.WR1.ID,
                            'WR': that.lineup.WR2.ID,
                            'WR': that.lineup.WR3.ID,
